    ...
    if (!stats) {
      return (
        <div className="text-center py-20">
          <AlertTriangle className="h-16 w-16 text-slate-600 mx-auto mb-6" />
          <p className="text-slate-400 text-xl mb-6">Erro ao carregar dados</p>
          <Button
            onClick={fetchStats}
  ...
  return (
    <SidebarProvider>
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex w-full relative overflow-hidden">
                ...
                <SidebarMenu>
                  <SidebarMenuItem>
                    <SidebarMenuButton
                      ...
                      className={`w-full justify-start ${activeSection === "overview" ? "bg-amber-500/20 text-amber-400" : ""}`}
                    >
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton
                      ...
                      className={`w-full justify-start ${activeSection === "users" ? "bg-amber-500/20 text-amber-400" : ""}`}
                    >
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton
                      ...
                      className={`w-full justify-start ${activeSection === "games" ? "bg-amber-500/20 text-amber-400" : ""}`}
                    >
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton
                      ...
                      className={`w-full justify-start ${activeSection === "financial" ? "bg-amber-500/20 text-amber-400" : ""}`}
                    >
                ...
                <SidebarMenu>
                  <SidebarMenuItem>
                    <SidebarMenuButton
                      ...
                      className={`w-full justify-start ${activeSection === "managers" ? "bg-amber-500/20 text-amber-400" : ""}`}
                    >
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton
                      ...
                      className={`w-full justify-start ${activeSection === "agents" ? "bg-amber-500/20 text-amber-400" : ""}`}
                    >
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton
                      ...
                      className={`w-full justify-start ${activeSection === "affiliates" ? "bg-amber-500/20 text-amber-400" : ""}`}
                    >
                ...
                <SidebarMenu>
                  <SidebarMenuItem>
                    <SidebarMenuButton
                      ...
                      className={`w-full justify-start ${activeSection === "settings" ? "bg-amber-500/20 text-amber-400" : ""}`}
                    >
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton
                      ...
                      className={`w-full justify-start text-red-400 hover:text-red-300 ${activeSection === "reset" ? "bg-red-500/20 text-red-400" : ""}`}
                    >
        ...
        {/* Modais */}
        {/* Modal de edição de taxa de comissão de afiliado */}
        {selectedAffiliate && (
            ...
            <Card className="w-full max-w-md border-slate-800/50 bg-slate-900/90 backdrop-blur-xl">
              <CardHeader>
                ...
                <CardDescription className="text-slate-400">
                  Alterar taxa para {selectedAffiliate.user_name}
                </CardDescription>
              </CardHeader>
        ...
        {/* Modal de alteração de senha de afiliado */}
        {selectedAffiliateForPasswordChange && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            <Card className="w-full max-w-md border-slate-800/50 bg-slate-900/90 backdrop-blur-xl">
              <CardHeader>
                <CardTitle className="text-white">Alterar Senha do Afiliado</CardTitle>
                <CardDescription className="text-slate-400">
                  Alterar senha para {selectedAffiliateForPasswordChange.user_name}
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  ...
                  />
                  {passwordChangeError && <p className="text-red-400 text-sm mt-1">{passwordChangeError}</p>}
                </div>
                <div className="flex space-x-3">
                  <Button
        ...
        {/* Modal de edição de taxa de comissão de agente */}
        {selectedAgent && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            <Card className="w-full max-w-md border-slate-800/50 bg-slate-900/90 backdrop-blur-xl">
              <CardHeader>
                <CardTitle className="text-white">Editar Taxa de Comissão</CardTitle>
                <CardDescription className="text-slate-400">Alterar taxa para {selectedAgent.user_name}</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  <Label htmlFor="agentCommissionRate" className="text-slate-300">
                    Nova Taxa de Comissão (%)
                  </Label>
                  <Input
        ...
        {/* Modal de edição de taxa de comissão de gerente */}
        {selectedManager && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            <Card className="w-full max-w-md border-slate-800/50 bg-slate-900/90 backdrop-blur-xl">
              <CardHeader>
                <CardTitle className="text-white">Editar Taxa de Comissão</CardTitle>
                <CardDescription className="text-slate-400">
                  Alterar taxa para {selectedManager.user_name}
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  <Label htmlFor="managerCommissionRate" className="text-slate-300">
                    Nova Taxa de Comissão (%)
                  </Label>
                  <Input
