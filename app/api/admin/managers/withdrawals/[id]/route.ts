...
import { updateManagerWithdrawalStatus } from "@/lib/manager-database"
...
export async function PUT(request: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    await updateManagerWithdrawalStatus(withdrawalId, status, notes)
    ...
    console.error("Erro ao atualizar saque de gerente:", error)
